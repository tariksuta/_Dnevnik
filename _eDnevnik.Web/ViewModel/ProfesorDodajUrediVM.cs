...
{
    public class ProfesorDodajUrediVM
    {
        ...
        [Required(ErrorMessage = "Niste unijeli raspored konsultacija.")]
        public int RasporedKonsultacijaID { get; set; }

        public List<SelectListItem> RasporedKonsultacija { get; set; }
